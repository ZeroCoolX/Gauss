...
public:
	MoveLeftShootLineEnemy(RenderWindow *window,
		...
		Vector2f forcedPosition = Vector2f(0.f, 0.f)) : EnemyLifeform(playerFollowNum, &EnemyLifeform::enemyTextures[EnemyLifeform::GetEnemyType(EnemyLifeform::MOVE_LEFT_SHOOT_LINE)], Vector2f(0.15f, 0.15f)) {
