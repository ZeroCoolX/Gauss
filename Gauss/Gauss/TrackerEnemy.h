...
public:
	TrackerEnemy(View& view,
		...
		Vector2f forcedPosition = Vector2f(0.f, 0.f)): EnemyLifeform(playerFollowNum, &EnemyLifeform::enemyTextures[EnemyLifeform::GetEnemyType(EnemyLifeform::FOLLOW)], Vector2f(0.12f, 0.12f)) {
